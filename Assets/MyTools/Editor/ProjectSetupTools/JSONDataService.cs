...
public class JsonDataService : IDataService
{
    ...
    public bool SaveData<T>(string RelativePath, T Data, bool Encrypted, string KEY, string IV)
    {
        ...
        try
        {
            ...
            if (Encrypted)
            {
                WriteEncryptedData(Data, stream, KEY, IV);
            }
            else
            {
                stream.Close();
    ...
    private void WriteEncryptedData<T>(T Data, FileStream Stream, string KEY, string IV)
    {
    ...
    public T LoadData<T>(string RelativePath, bool Encrypted, string KEY, string IV)
    {
        string path = RelativePath;
        ...
        try
        {
            ...
            if (Encrypted)
            {
                data = ReadEncryptedData<T>(path, KEY, IV);
            }
            else
            {
    ...
    private T ReadEncryptedData<T>(string Path, string KEY, string IV)
    {
